    ...
    <aside className="flex h-screen w-60 shrink-0 flex-col border-r border-border/60 bg-card/40">
      ...
      <div className="flex h-16 items-center gap-3 border-b border-border/60 px-5">
        ...
        <div className="flex flex-col leading-tight">
          <span className="text-sm font-semibold">Mediabuyer</span>
          <span className="text-[11px] text-muted-foreground">Agency OS</span>
        </div>
      </div>
      ...
      <div className="border-t border-border/60 px-3 py-4">
        <div className="flex items-center gap-3 rounded-md px-2 py-2">
          <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-violet-400 to-purple-500 text-xs font-semibold text-white">
            {user.name
              .split(" ")
              .map((n) => n[0])
              .slice(0, 2)
